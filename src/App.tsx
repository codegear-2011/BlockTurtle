...
export default function App() {
  ...
  const runCode = async () => {
    ...
    const moveSteps = (steps: number) => {
      ...
      currentY -= steps * Math.sin(rad); // Flip Y for canvas coords
    ...
    try {
      ...
      const runner = new AsyncFunction('moveSteps', 'turnRight', 'turnLeft', 'say', 'wait', codeToRun);
      await runner(moveSteps, turnRight, turnLeft, say, wait);
    } catch (e) {
